...
public:
    ...
    void setSerialDisplayMirror(bool enabled);
    void setSerialTunerStream(bool enabled);
...
private:
    ...
    bool serialDisplayMirrorEnabled_ = false;
    bool serialTunerStreamEnabled_ = false;
    unsigned long lastSerialDisplayMirrorTimestamp_ = 0;
    unsigned long lastSerialTunerStreamTimestamp_ = 0;
    const unsigned long serialDisplayMirrorInterval_ = 250;
    const unsigned long serialTunerStreamInterval_ = 100;
    ...
    string serialSafeText(string value);
    void emitSerialDisplayMirror(OperationMode opMode, SubMode subMode);
    void emitSerialTunerStream();
    void logDisplay();
