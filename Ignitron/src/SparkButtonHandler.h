...
private:
    ...
    static unsigned long bankComboStarted_;
    static bool bankComboActive_;
    static bool bankComboHandled_;

    static void resetBankButtons();
    static bool isBankComboPressed();
